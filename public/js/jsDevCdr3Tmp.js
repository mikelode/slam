                     ...
                     if(  varCdr.cdrOPE =="DEL" ) varCdr.cdrObsv  = $("#txCC_Motivo").val();
                                ...
                                $.ajax({
                                    ...
                                    success: function (VR) {
                                        ...
                                        $("#divDialog").dialog({
                                            buttons: {
                                                "Aceptar": function () {jsFunDBCC_GetData("CID",VR["Result"][0].CCNo);           }}});
                                    }
                                });
...
function jsFunDBCC_GetData(Tipo,valor)
{
    var qry = "";
