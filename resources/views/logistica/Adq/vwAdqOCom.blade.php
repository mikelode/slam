...
@if(auth()->user()->permiso('LOG_LOG_OC','GUARDAR',Auth::user()->usrID) || auth()->user()->permiso('LOG_LOG_OC','EDITAR',Auth::user()->usrID))
...
@if(auth()->user()->permiso('LOG_LOG_OC','GUARDAR',Auth::user()->usrID))
...
@if(auth()->user()->permiso('LOG_LOG_OC','EDITAR',Auth::user()->usrID))
          {!! Form::button('EDITAR',['class'=>'btn btn-default','id'=>'btnLogOCUpd','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'EDITAR','style'=>' margin-left:2px;font-weight: bold; padding-left:6px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconUPD.png) no-repeat; background-position:top;' ]) !!}
@endif

@if(auth()->user()->permiso('LOG_LOG_OC','GUARDAR',Auth::user()->usrID))
          {!! Form::button('ANULAR',['class'=>'btn btn-default','id'=>'btnLogOCDel','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'ANULAR','style'=>' margin-left:2px;font-weight: bold; padding-left:4px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconDEL.png) no-repeat; background-position:top;' ]) !!}
...
@if(auth()->user()->permiso('LOG_LOG_OC','IMPRIMIR',Auth::user()->usrID))
...
@if(auth()->user()->permiso('LOG_LOG_OC','ELIMINAR',Auth::user()->usrID))
