...
<div class="panel-body">
     ...
     <div class="panel-heading gs-panel-heading"  style=" position: relative;border-radius: 5px; width: 1140px ;  height: 55px; border: 1px solid #cecece ; padding-top: 0px; margin-top: 0px ; margin-bottom:10px; background: #f6f6f6 ;" >
        ...
        <img src="img/pestana1.png" width="40px" height="40px" style="margin-right: 10px">
            ...
            <td ALIGN="LEFT">
            <span style="font-size: 16px;"> REGISTRO DE DEPENDENCIAS DE LA ENTIDAD</span>
            </td>
    ...
    <tr valign="center">
        <td> {!! Form::text('txDepAutoDsc', null, array('class' => 'form-control ', 'placeholder'=>'Dependencia', 'style'=>'width:960px; height:35px ; ','id'=>'txDepAutoDsc'    ))  !!} </td>
        <td align="LEFT" width="215px">   <span id="btnDepRowNEW" class="btn btn-info" STYLE="WIDTH:150PX;height: 35px; padding-top: 10px; font-weight: bold; margin-left:20px;"> Nuevo Registro</span>     </td>
    </tr>
    </table>
