...
<div class="panel-heading gs-panel-heading"  style=" border-radius: 5px; width: 1140px ;  height: 300px; border: 1px solid #ddd ; padding-top: 0px; margin-top: 0px ; margin-bottom:5px; background: #f9f9f9 ;   " >
               ...
               <td>
                ...
                <table  class="gs-table">
                 ...
                 <td  align="right"> </td>
                 <td  align="left">
                     <button id="btnLogItem" class="btn btn-primary" style="height: 35px; padding:0 3px 0 3px; font-size:11px; margin-left:65px;">
                         <span class="glyphicon glyphicon-plus-sign"></span>
                         <span class="btnTxt">NUEVO ITEM</span>
                     </button>
                 </td>
                 </tr>
                 </table>
...
<div class="panel-heading gs-panel-heading" >
    :::  Lista de Bienes o Servicios
    <div class="pull-right" id="stxMontoReq" style="margin-right: 140px;">
    </div>
</div>
<div id="dvBarraAdd" class="panel-heading gs-panel-heading" style="display: none;" >
     <table id="tbBarraBienes" style="height: 50px; table-layout: fixed;" width="100%">
     ...
     <tbody>
      <tr class="fila-Hide">
         <td name="tdID"  style="display: none" >1</td>
          <td name="tdSF" style="display: none;" align="center"></td>
          <td name="tdRubro" style="display: none;" align="center"></td>
         ...
         <td BGCOLOR="#d9edf7">
             <button id="btnLogItemEDIT" class="btn btn-warning editRow" style="width:45Px;height:25px; padding:0px; padding-left: -10px; font-size:9px;  " type="button">EDIT</button>
         </td>
         <td BGCOLOR="#d9edf7" >
             <button id="btnLogItemDEL" class="btn btn-danger deleteRow" style="width: 30px  ;height: 25px ; padding:0px; font-size:10px;  " type="button">X</button>
         </td>
     </tr>
    </tbody>
    </table>
