 ...
 <div class="panel-heading gs-panel-heading"  style=" position: relative;border-radius: 5px; width: 1140px ;  height: 55px; border: 1px solid #cecece ; padding-top: 0px; margin-top: 0px ; margin-bottom:10px; background: #f6f6f6 ;" >
    ...
    <img src="img/pestana1.png" width="40px" height="40px" style="margin-right: 5px">
       ...
       <td align="right" width="715px">
            ...
            {!! Form::button('REVERSAR',['class'=>'btn btn-default','id'=>'btnLogCCBusy','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'RESERVAR','style'=>' margin-left:2px;font-weight: bold; padding-left:4px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconBusy.png) no-repeat; background-position:top;' ]) !!}
