 ...
 <div class="panel-heading gs-panel-heading"  style=" position: relative;border-radius: 5px; width: 1140px ;  height: 55px; border: 1px solid #cecece ; padding-top: 0px; margin-top: 0px ; margin-bottom:10px; background: #f6f6f6 ;" >
    ...
    <img src="img/tabCtz.png" width="40px" height="40px" style="margin-right: 10px">
        ...
        <td>
         ...
         @if(auth()->user()->permiso('LOG_LOG_CZ','GUARDAR',Auth::user()->usrID) || auth()->user()->permiso('LOG_LOG_CZ','EDITAR',Auth::user()->usrID))
         ...
         @endif
         @if(auth()->user()->permiso('LOG_LOG_CZ','GUARDAR',Auth::user()->usrID))
         ...
         @endif
         @if(auth()->user()->permiso('LOG_LOG_CZ','EDITAR',Auth::user()->usrID))

          {!! Form::button('EDITAR',['class'=>'btn btn-default','id'=>'btnLogCtzUpd','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'EDITAR',  'style'=>' margin-left:2px;font-weight: bold; padding-left:8px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconUPD.png) no-repeat; background-position:top;']) !!}

         @endif
         @if(auth()->user()->permiso('LOG_LOG_CZ','GUARDAR',Auth::user()->usrID))

          {!! Form::button('ANULAR',['class'=>'btn btn-default','id'=>'btnLogCtzDel','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'ANULAR',   'style'=>' margin-left:2px;font-weight: bold; padding-left:4px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconDEL.png) no-repeat; background-position:top;' ]) !!}
         ...
         @endif
             @if(auth()->user()->permiso('LOG_LOG_CZ','IMPRIMIR',Auth::user()->usrID))
          ...
          {!! Form::button('IMPRIMIR',['class'=>'btn btn-default','id'=>'btnLogCtzPrint','data-toggle'=>'tooltip' ,'data-placement'=>'bottom','title'=>'IMPRIMIR','style'=>' margin-left:2px;font-weight: bold; padding-left:4px; ;padding-top:35px; font-size:9px;;width:50px; height:50px; background: url(img/iconPRINT.png) no-repeat; background-position:top;' ]) !!}
             ...
             @endif
             @if(auth()->user()->permiso('LOG_LOG_CZ','ELIMINAR',Auth::user()->usrID))
