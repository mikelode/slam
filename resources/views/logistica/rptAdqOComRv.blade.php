    ...
    <tr valign="top">
       ...
       <td>
        ...
        <tr ><td   colspan="2">  </td></tr>       
			  <tr ><td style="font-size:12px; font-weight:bold;" > <label class="labels"  > RAZON SOCIAL: </label>   <SPAN style="font-size:30px">  ANULADO </SPAN>    </td><td> <label class="labels" > RUC : </label>  <label CLASS="labels" style="font-size: 16px; font-weight:bold;">      </label>  </td></tr>
        <tr ><td  colspan="2" style="font-size:11px; font-weight:normal;"> <label class="labels" >  DIRECCION: </label>     </td>  </tr>
				<tr ><td  colspan="2" style="font-size:11px; font-weight:normal;"> <label class="labels" >  GLOSA: </label>    </td>  </tr>
        @if (strlen(  $ReturnData["OC"][0]->ocMotivo ) < 4	)
				<tr ><td  colspan="2" > <label class="labels">  LUGAR ENTREGA :</label> <strong>   </strong></td> </tr> 
				@endif
        <tr > <td colspan="2"> Factura a Nombre de : <label class="labels"> {{ config('slam.APP_ENTIDAD') }} &nbsp; &nbsp; &nbsp; &nbsp;  CON RUC : </label> <strong> {{ config('slam.ENTIDAD_RUC') }} </strong>  </td> </tr>
            ...
            <div class="info">
            <table >
                <tr ><td  STYLE="font-size:11px;"> <label class="labels"> DEPENDENCIA : </label><strong> </strong>  </td></tr>
                
                <tr ><td  STYLE="font-size:11px;"> <label class="labels"> SEC FUN : </label>  <strong> </strong>  </td></tr>
              


                <tr ><td  STYLE="font-size:11px;"> <label class="labels"> RUBRO : </label> <strong> </strong> </td></tr>
                <tr ><td  STYLE="font-size:12px;"> <label class="labels"> REFERENCIA : </label> <strong> </strong> </td></tr>
            </table>
            </div>
      ...
      @if(  $ReturnData["OC"][0]->ocTipoProcID=="009"  &&   $ReturnData["OC"][0]->ocIGV=="SI")    
        ...
        <tbody >
                <tr class="dll">
                         ...
                         <td   class="dll rights" ALIGN="right" style="font-weight:normal;font-size:14px;" ></td>
                </tr>

                <tr class="dll">
                               
                         <td  class="dll rights" ALIGN="right"  >Descuento :  </td>
                         <td ALIGN="center "  class="dll rights  " style="font-weight:normal;font-size:14px;"> </td>
                </tr>
                <tr class="dll">
       ...
       <!-- <td  class="dll"  align="left" style="font-size: 12px; font-weight: bold;text-align:left;" >  </td>-->
           <td   class="dll rights" align="right" style="font-size: 15px; font-weight: bold;" > TOTAL :     </td>
        </tr>
       </TABLE> 
  	...
  	{!! $ReturnData["OC"][0]->ocCondicion !!}	  
       ...
       <table  style="font-size: 9px; margin-left:-5px ; margin-top:-13px; " width="100%" >
        <thead>
         ...
         <tbody>
       <tr style="text-align:left;">
        <td  class="dll"  align="left" style="font-size: 12px; font-weight: bold;text-align:left;" > Son:  </td>
        <td   class="dll rights" align="right" style="font-size: 15px; font-weight: bold;" > TOTAL :      </td>
        </tr>
         </tbody>
       </TABLE> 
      ...
      <tr>
          ...
          <div style="display: inline-block; font-size: 12px; margin-left: 0px; font-weight:bold;  ">
               ...
               <td  class="dll lefts"  valign="top">
      				   <table >
      						<tr> <td ><label class="labels"> OBSV :</label> <label style="font-size: 12px; width: 150px; "> </label></td>  </tr>
      				  </table>
              </td>
