    <div class="modal fade"  id="modalCatalogo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"   >
       ...
       <div class="modal-content">
            <div class="modal-header" >
                             ...
                             <img src="img/pestana1.png" width="20px" height="20px" style=" MARGIN-top:-5px; margin-right: 3px"><span style="font-size: 11px;  font-family:  Arial, Helvetica, Verdana  "> REGISTRO DE NUEVO ITEM EN CATÁLOGO </span>
                             </div></div>
									...
									<tr valign="center" >
										...
										<td> {!! Form::text('txDsc', null, array('class' => 'form-control ', 'placeholder'=>'', 'style'=>'width:600px; height:40px','id'=>'txDsc'    ))  !!} </td>
