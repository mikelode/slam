 <div class="modal fade"  id="modalCCSearch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="  overflow-x:scroll" >
   ...
   <div class="modal-content">
        ...
        <td  align="center" >{{  $nom->cdrFecha}}</td>
        <td  align="center" style="font-size: 12px" > <strong>{{  $nom->cdrCodigo}}</strong></td>
        <td  align="center" >{{  $nom->cdrRuc}}</td>
        <td  align="left" >{{  $nom->cdrRSocial}}</td>
        <td  align="center" >-</td>
