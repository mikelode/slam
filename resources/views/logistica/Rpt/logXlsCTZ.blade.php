...
<tr style="height: 20px;background:#c0c0dd" >
        ...
        @foreach($result["CTZ"] as $key=>$nom)
        <tr style="height: 20px;" >
               <td   style="mso-number-format:'@'" align="center" >{{$key+1}}</td>
               <td   >{{ $nom->ctzAnio}}</td>
               <td   >{{ $nom->ctzEtapa}}</td>
               <td   >{{ $nom->ctzTipoReqDsc}}</td>

               <td   >{{ $nom->ctzCodigo}}</td>
               <td style="mso-number-format:'@'"  >{{ $nom->ctzFecha}}</td>
               
               <td   >{{ $nom->ctzRef}}</td>
               <td   >{{ $nom->ctzGlosa}}</td>

              <td  style="mso-number-format:'@'" >{{ $nom->ctzDepCod}}</td>
               <td   >{{ $nom->ctzDepDsc}}</td>

               <td  style="mso-number-format:'@'" >{{ $nom->ctzSecFunCod}}</td>
               <td   >{{ $nom->ctzSecFunDsc}}</td>

               <td  style="mso-number-format:'@'" >{{ $nom->ctzRubroCod}}</td>
               <td   >{{ $nom->ctzRubroDsc}}</td>
                <td   >{{ $nom->ctzLugarEnt}}</td>
                 <td  style="mso-number-format:'@'" >{{ $nom->ctzUsrID}}</td>
