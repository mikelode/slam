...
<tr style="height: 20px;background:#c0c0dd" >
        <td valign="center" colspan="24"> <h4>REPORTE DETALLADO DE ORDENES DE COMPRA Y SERVICIOS</h4></td>        </tr>
</table>
...
?>
 ...
 <div class="panel panel-default" style="margin-top: -10px; margin-bottom: -5px; padding: 2px; " >
  <table>
  <tr>
    <td><DIV style="background:#f2f2f2;width: 850px;padding:2px;border-radius:5px;"   >  <h4 style="">REPORTE DETALLADO DE DE ORDENES DE COMPRA Y SERVICIO</h4>       </DIV> </td>
