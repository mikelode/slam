    ...
    <div class="ribbon-tab file" id="file-tab">
        <span class="ribbon-title">Usu: {{ auth()->user()->persona->perNombres }}</span>
...
{{--             <div class="ribbon-button ribbon-button-large" id="btnMainLogSiafSeg" style="width:80px">
          ...
          <div class="ribbon-section">
           ...
           <span class="section-title"><a id="CloseSys" href="./auth/logout" ></a></span>
            ...
            <img class="ribbon-icon ribbon-normal" src="{{ asset('img/iconExit.png') }}" />
            </div>
    ...
    <div class="ribbon-tab" id="tabLogistica">
        ...
        <div class="ribbon-section">
            ...
            @if(auth()->user()->permiso('LOG_LOG_CZ','VER',Auth::user()->usrID))
        ...
        <div class="ribbon-section">
         ...
         <div class="ribbon-section">
              ...
              <span class="button-title">Record de <br>Proveedores</span>
...
<div class="ribbon-tab" id="almacen-tab">
        ...
        <div class="ribbon-section">
            ...
            <div class="ribbon-button ribbon-button-large" id="btn-menuInternamiento">
                ...
                <img class="ribbon-icon ribbon-normal" src="{{ asset('img/iconInter.png') }}" />
            </div>
            <div class="ribbon-button ribbon-button-large" id="btn-menuDistribucion">
                ...
                <img class="ribbon-icon ribbon-normal" src="{{ asset('img/iconPcs.png') }}" />
            </div>
        </div>
        <div class="ribbon-section">
...
<script>
    ...
    $('#btnTramBandeja').click(function(e){
        e.preventDefault();
        var url = 'tramite';
        $.get(url,function(data){
            $('.alm-content-wrapper').html(data);
