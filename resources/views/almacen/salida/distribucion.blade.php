                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group alm-form-group">
                                       ...
                                       <div class="form-group alm-form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control alm-input formatDni" id="dniReceptor" type="text" data-aim="dniRecep" name="receportDniApplicant"  placeholder="DNI (F2)">
                                        </div>
                                        <div class="col-sm-7">
                                            <input class="form-control alm-input" id="fnameReceptor" type="text" name="receptorNameApplicant" value="" placeholder="NOMBRE COMPLETO">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group alm-form-group">
                                        ...
                                        <div class="col-sm-7">
                                        <input class="form-control alm-input" id="depDsc" type="text" name="depDscNameApplicant" value="" placeholder="DEPENDENCIA">
                                          <!--  <input class="form-control alm-input" type="text" name="disRole" placeholder="CARGO">-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group alm-form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control alm-input" id="guiarem" type="text" data-aim="dep" name="guiarem" value="" placeholder="GUIA DE REMISION">
                                        </div>
