...
<tr><td> RUC           </td>    <td WIDTH="20PX" ALIGN="CENTER" > : </td>
    <td> <table><tr><td><input id="txRUC" name="txRUC" class="form-control gs-input" placeholder="Nro de RUC" autofocus style="width: 110px; font-weight: bold; font-size: 14px; HEIGHT:35PX;"  /> </td>
    <td> <button id="btnLogCCRucSUNAT" class="btn btn-primary" style=" margin-left: 5px; width:  120px;font-size: 14px; font-weight: bold; height: 35px; ">
